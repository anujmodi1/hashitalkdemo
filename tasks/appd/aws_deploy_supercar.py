...
url = "http://dev-vault.devops-ontap.com:8200/v1/concourse/cisco-fso-labs/" + name + "/" + "supercar_instance_id"
print(url)
...
url = "http://dev-vault.devops-ontap.com:8200/v1/concourse/cisco-fso-labs/" + name + "/" + "supercar_ip"
print(url)
